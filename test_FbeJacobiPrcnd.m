...
monotonic_steps=zeros(test_points,1);
%%
for i=1:test_points
    ops_FBE.x0=Xtest(:,i);
    %%
    ...
    %{
    [Zclass_LBFS,Yclass_LBFS,Details_LBFS]=FBE_algo_prcnd.Dual_FBE(ops_FBE.x0);
    ...
    %
    % Accelerated FBE
    [Zclass_AcceLBFS,Yclass_AcceLBFS,Details_AcceLBFS]=FBE_algo_prcnd.Dual_AccelGlobFBE(ops_FBE.x0);
    % plot(Details_AcceLBFS.cost_function)
    monotonic_steps(i)=Details_AcceLBFS.monotonicity_steps;
