...
for i=1:test_points
    ...
    [Zclass_FBE_prcnd,Yclass_FBE_prcnd,Details_FBE_prcnd]=FBE_algo_prcnd.Dual_GlobalFBE(ops_FBE.x0);
    ...
    [Zclass_FBE_simple,Yclass_FBE_simple,Details_FBE_simple]=...
        FBE_algo_simple.Dual_GlobalFBE(ops_FBE.x0);
    ...
    [Zclass_FBE,Yclass_FBE,Details_FBE]=FBE_algo.Dual_FBE_extGrad(ops_FBE.x0);
    %
